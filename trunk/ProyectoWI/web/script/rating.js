 ...
 *
 * By Ville SÃ¤Ã¤vuori <Ville@Unessa.net>
...
var rating = {
    ...
    reset_stars: function() {
        ...
        if (rating.submitted == false) {
            stars_on = rating.average[0];
            if (rating.average[1] >= 0)
                stars_on = parseInt(rating.average[0]) + 1;
            last_star_width = rating.average[1] + '0%';
        } else {
    ...
    submit_rating: function(e, num) {
        ...
        if (rating.submitted == false) {
            ...
            rating.notifytext.innerHTML = 'Se está guardando la puntuación.';
    ...
    ajax_callback: {
        success: function(o) {
            ...
            rating.submitted = false;
            rating.notifytext.innerHTML = 'Puntuación guardada.';
        },
