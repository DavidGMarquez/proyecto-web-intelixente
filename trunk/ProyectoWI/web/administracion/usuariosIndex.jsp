...
<html>
    <head>
        ...
        <script type="application/x-javascript" src="../script/administracion/usuarios.js"></script>
        <title>Administracion de usuarios</title>
    </head>
    <body onload="recuperaUsuarios(<c:out value='${pagina}'/>)">
        <div id="titulo">Administración: Usuarios</div>
        <%@ include file="menu.jsp"%>
        <div id="comentario"><span><c:out value="${comentario}"/></span></div>
        <div id="usuarios">Cargando...</div>
    </body>
</html>
